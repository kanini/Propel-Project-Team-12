...
public class WaitlistEntryConfiguration : IEntityTypeConfiguration<WaitlistEntry>
{
    public void Configure(EntityTypeBuilder<WaitlistEntry> builder)
    {
        ...
        // FK: WaitlistEntry -> TimeSlot (notified slot, US_041)
        ...
        // Notification lifecycle indexes (US_041)
        ...
        // Partial index for timeout detection job: find Notified entries past deadline
