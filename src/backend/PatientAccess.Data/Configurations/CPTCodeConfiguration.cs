...
/// <summary>
/// EF Core Fluent API configuration for the CPTCode entity (AIR-R04, DR-010).
...
public class CPTCodeConfiguration : IEntityTypeConfiguration<CPTCode>
{
    public void Configure(EntityTypeBuilder<CPTCode> builder)
    {
        ...
        builder.HasIndex(e => e.Code)
            .IsUnique()
            .HasDatabaseName("IX_CPTCodes_Code_Unique");
        ...
        builder.HasIndex(e => e.Embedding)
            .HasDatabaseName("IX_CPTCodes_Embedding_HNSW");
