...
export const MyAppointments: React.FC = () => {
     ...
     */
    const renderAppointmentsTab = (appointmentsList: Appointment[], type: 'upcoming' | 'past') => {
        // Loading state
                ...
                {appointmentsList.map((appointment) => (
                    ...
                    >
                        <div className="flex justify-between items-start mb-4">
                            ...
                            <span
                                className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${appointment.status === 'Scheduled'
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                            ...
                            <div>
                                <p className="text-xs text-gray-500 uppercase tracking-wide">Visit Reason</p>
                                <p className="text-sm font-medium text-gray-900 mt-1">
                ...
                >
                    <div className="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-red-700 mt-1">{waitlistError.message}</p>
                            <button
    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-6xl">
            ...
            <div className="mb-6">
                ...
                <p className="text-gray-600 mt-1">View and manage your appointments and waitlist entries</p>
            </div>
